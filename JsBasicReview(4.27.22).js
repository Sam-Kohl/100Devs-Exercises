...
let totalCandiesNeeded  = ( bulbasaurCandies + caterpieCandies + weedleCandies)
...
function canCharmanderFight(temp){
    let result = convertToCelcius(temp);
    return result > 0 ? 'Charmander can fight!' : 'No fighting for Charmander.'
}
//Loops
//You have joined an undeground pokemon leauge. In this league, trainers can use any number of pokemon. Print to the console "Pikachu I choose you" x times where x is the number of pokemon the trainer you are battling has in their party

let numOfPoke = 10;
for(let i = 0; i < numOfPoke; i++){
